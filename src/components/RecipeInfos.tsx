...
import {
  RECIPE_INFOS_AMOUNT_LABEL,
  RECIPE_INFOS_AMOUNT_PLACEHOLDER,
  RECIPE_INFOS_NAME_LABEL,
  RECIPE_INFOS_NAME_PLACEHOLDER,
  RECIPE_THUMBNAIL_CALL_TO_ACTION,
  RECIPES_INFO_PIECES_KIND_PLACEHOLDER,
} from "../constants/text";
...
export const RecipeInfos: React.FC<Props> = () => {
  ...
  return (
    <div className="flex flex-row space-y-4 space-x-5 h-[150px]">
      <div className="relative flex flex-row size-[150px]">
        {formData.thumb.nail ? (
          <div className="size-[150px]">
            <img
              src={"data:image/jpeg;base64," + formData.thumb.nail}
              alt="Vorschaubild"
      ...
      <div className="w-full h-full space-y-2 flex flex-col justify-between">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                {RECIPE_INFOS_NAME_LABEL}* <FormMessage />
              </FormLabel>
              <FormControl>
            ...
            render={({ field }) => (
              <FormItem className="w-half">
                ...
                <FormControl>
                  <Input
                    type="number"
                    placeholder={RECIPE_INFOS_AMOUNT_PLACEHOLDER}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input
                    placeholder={RECIPES_INFO_PIECES_KIND_PLACEHOLDER}
                    {...field}
                  />
                </FormControl>
              </FormItem>
